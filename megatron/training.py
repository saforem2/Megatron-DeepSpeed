...
from megatron.training_log import training_log as training_log_microsoft
from megatron.training_log_alcf import training_log as training_log
    ...
    if args.deepspeed:
        ...
        if (
            ...
            if mpu.get_tensor_model_parallel_rank() == 0:
                log.info(f"Caught 'mpu.get_tensor_model_parallel_rank() == 0'")
...
def evaluate_and_print_results(
    ...
    from megatron.training_log import interop_tool_logger
